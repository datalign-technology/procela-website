// Homepage FAQ content. Shared so the interactive <Faq /> component and the
// FAQPage structured data (JSON-LD) on the homepage stay in lockstep.
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Yes. Procela's principal model supports both human and AI participants as data stewards and domain owners. AI agents are AI-assisted and review-gated — their classifications and suggestions are surfaced for a person to review and approve before anything is applied.",
  },
];
